<template>
    <div>
        ...
        <div id="book-wrapper" :class="{loading: dataLoading}">
            <div v-if="abstractBookData" id="abstract-book">
                <div class="section" v-for="(section, sIndex) in abstractBookData" :key="sIndex">
                    <div class="section-title" style="text-align: center;">
                        <strong><div class="section__name">{{ section.sectionName }}</div></strong>
                        <strong><div class="section__subheading">Oral Presentations</div></strong>
                    </div>
                    <br><br>
                    <div class="abstracts-wrapper" style="text-align: justify; text-justify: none;">
                        <div class="abstract" v-for="(oral, oIndex) in section.orals" :key="oIndex">
                            <div class="abstract__title-wrapper">
                                <span class="abstract__authors" v-html="oral.paper_authors"></span>
                                <strong><span class="abstract__title" v-html="formatTitle(oral.title)"></span></strong>
                            </div>
                            <div class="abstract__content" v-html="formatHTML(oral.paper_abstract)"></div>
                            <br><br>
                        </div>
                    </div>
                    <!-- Posters -->
                    <div class="section-title" style="text-align: center;">
                        <strong><div class="section__name">{{ section.sectionName }}</div></strong>
                        <strong><div class="section__subheading">Poster Presentations</div></strong>
                    </div>
                    <br><br>
                    <div class="abstracts-wrapper" style="text-align: justify;">
                        <div class="abstract" v-for="(poster, pIndex) in section.posters" :key="pIndex">
                            <div class="abstract__title-wrapper">
                                <span class="abstract__authors" v-html="poster.paper_authors"></span>
                                <strong><span class="abstract__title" v-html="formatTitle(poster.title)"></span></strong>
                            </div>
                            <div class="abstract__content" v-html="formatHTML(poster.paper_abstract) "></div>
                            <br><br>
                        </div>
                    </div>
                </div>
            ...
            <div id="no-book-data" v-else>
                <loader :loading="dataLoading && !abstractBookData"></loader>
    ...
    export default {
        ...
        methods: {
            copyToClipboard () {
                ...
                console.log('COPIED ABSTRACT BOOK TO CLIPBOARD')
            },
